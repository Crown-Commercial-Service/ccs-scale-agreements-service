...
public interface ContactPointLotOrgRoleRepo extends JpaRepository<ContactPointLotOrgRole, Integer> {
    ...
    ContactPointLotOrgRole findById(int id);

    Optional<ContactPointLotOrgRole> findByContactDetailIdAndContactPointReasonIdAndLotOrganisationRoleId(int contactDetailId, int contactPointReasonId, int lotOrganisationRoleId);
